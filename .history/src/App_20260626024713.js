  ...
  return (
    <>
      ...
      <footer className="footer-section">
        ...
        {/* Efek Glass Blur Latar Belakang */}
        <div className="footer-container">
          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p>
                Membangun antarmuka digital yang interaktif, responsif, dan
            ...
            <div className="footer-socials">
              ...
              <div className="footer-icons">
                ...
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=emailkamu@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <i className="bx bx-envelope"></i>
          ...
          <div className="footer-bottom">
            <p>
              &copy; {new Date().getFullYear()} Alexandre. All Rights Reserved.
            </p>
            <p className="footer-crafted">
              Crafted with <i className="bx bxs-heart cyan-glow-heart"></i> &
              React
            </p>
          </div>
        </div>
