...
{/* FOOTER SECTION */}
      <footer className="footer-section">
        <div className="footer-glass-backdrop"></div> {/* Efek Glass Blur Latar Belakang */}
        <div className="footer-container">
          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p>Membangun antarmuka digital yang interaktif, responsif, dan berorientasi pada kenyamanan pengguna.</p>
            </div>
            ...
            <div className="footer-socials">
              ...
              <div className="footer-icons">
                <a href="https://github.com/usernamekamu" target="_blank" rel="noreferrer">
                  <i className="bx bxl-github"></i>
                </a>
                <a href="https://linkedin.com/in/usernamekamu" target="_blank" rel="noreferrer">
                  <i className="bx bxl-linkedin"></i>
                </a>
                <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer">
                  <i className="bx bxl-whatsapp"></i>
                </a>
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=emailkamu@gmail.com" target="_blank" rel="noreferrer">
                  <i className="bx bx-envelope"></i>
                </a>
              </div>
            </div>
          ...
          {/* Sisi Bawah Footer (Copyright) */}
          <div className="footer-bottom">
            <p>&copy; {new Date().getFullYear()} Alexandre. All Rights Reserved.</p>
            <p className="footer-crafted">Crafted with <i className="bx bxs-heart cyan-glow-heart"></i> & React</p>
          </div>
