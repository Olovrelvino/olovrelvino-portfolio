...
<a href="#home" className="logo">
        ...
        <nav className={`navbar ${isMenuOpen ? "active" : ""}`}>
          <a href="#home" key={`home-${language}`} onClick={() => setIsMenuOpen(false)}>
            {language === "ID" ? "Beranda" : "Home"}
          </a>
          <a href="#about" key={`about-${language}`} onClick={() => setIsMenuOpen(false)}>
            {language === "ID" ? "Tentang" : "About"}
          </a>
          <a href="#portfolio" key={`port-${language}`} onClick={() => setIsMenuOpen(false)}>
            {language === "ID" ? "Proyek" : "Projects"}
          </a>
          <a href="#contact" key={`cont-${language}`} onClick={() => setIsMenuOpen(false)}>
        ...
        <div className="header-right-wrapper">
          ...
          >
            ...
            <i className="bx bx-globe" style={{ marginRight: '5px', fontSize: '0.9rem' }}></i>
            {language === "ID" ? "EN" : "ID"}
          </button>
