...
function App() {
  ...
  const t = {
      ...
      experiences: [
        {
          ...
          items:
            language === "ID"
              ? [
                  <div className="title-no-bullet" key="ui-title">
                    <strong>
                      <em>User Interface Design (UI)</em>
                    </strong>
                  </div>,
                  "Mendesain antarmuka yang ramah pengguna dan konsisten secara visual untuk aplikasi berbasis web menggunakan Figma.",
                  "Membangun dan menerapkan Design System terstruktur yang terdiri dari komponen yang dapat digunakan kembali seperti tombol, tipografi, palet warna, jarak, ikon, dan kolom input untuk menjaga konsistensi visual di seluruh layar.",
                  "Membuat wireframe low-fidelity dan high-fidelity untuk mengubah kebutuhan menjadi tata letak antarmuka yang terstruktur.",
                  "Mengembangkan prototipe interaktif untuk mensimulasikan interaksi pengguna dan memvalidasi perilaku antarmuka sebelum evaluasi akhir.",
                  "Melakukan usability testing untuk mengevaluasi efektivitas antarmuka, mengidentifikasi masalah kegunaan, dan menyempurnakan desain berdasarkan masukan pengguna.",
                  <div className="exp-spacer" key="spacer"></div>,
                  <div className="title-no-bullet" key="ux-title">
                    <strong>
                      <em>User Experience Design (UX)</em>
                    </strong>
                  </div>,
                  "Menerapkan metodologi Design Thinking untuk mengidentifikasi masalah pengguna dan menciptakan solusi yang berpusat pada pengguna.",
                  "Melakukan riset pengguna melalui observasi dan analisis perilaku pengguna untuk memahami kebutuhan dan kendala pengguna.",
                  "Membuat user persona, user journey map, dan user flow untuk menganalisis perilaku pengguna dan mengoptimalkan pengalaman produk.",
                  "Mengidentifikasi pernyataan masalah utama dan menghasilkan ide solusi selama proses ideasi.",
                ]
              : [
                  <div className="title-no-bullet" key="ui-title">
                    <strong>
        ...
        },
        {
          ...
          company:
            language === "ID"
              ? "Panitia LDKM (Latihan Dasar Kepemimpinan Mahasiswa)"
    ...
    skills: {
      ...
      brief:
        language === "ID"
          ? "Kombinasi keahlian teknis dalam rekayasa perangkat lunak, pengembangan web modern, dan desain antarmuka berbasis pengguna untuk membangun solusi digital yang fungsional dan terukur."
          : "A combination of technical expertise in software engineering, modern web development, and user-centered design to build functional and scalable digital solutions.",
      ...
      skill2Sub: language === "ID" ? "HTML5, CSS3, JS" : "HTML5, CSS3, JS",
      skill3Title:
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        /* rootMargin memberikan batas imajiner di dalam viewport.
          -30% top dan -50% bottom artinya pemicu aktif berada tepat 
          di area tengah layar, sangat ideal untuk tipe website single-page portfolio.
        */
        rootMargin: "-30% 0px -50% 0px",
        threshold: 0, // Langsung picu begitu elemen menyentuh batas margin imajiner
      },
    );
        ...
        <div className="skills-center-container">
          ...
          <div className="skills-metrics-grid">
            ...
            <div className="metric-card">
              ...
              <div className="metric-percentage">75%</div>
            </div>
          </div>
        </div>
      </section>
