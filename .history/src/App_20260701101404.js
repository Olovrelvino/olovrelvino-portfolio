...
language === "ID"
              ? [
                  <div className="title-no-bullet" key="ui-title"><strong><em>User Interface Design (UI)</em></strong></div>,
                  ...
                  <div className="title-no-bullet" key="ux-title"><strong><em>User Experience Design (UX)</em></strong></div>,
