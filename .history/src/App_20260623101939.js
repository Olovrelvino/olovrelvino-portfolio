...
function App() {
  ...
  const popupDetails = {
    project1: {
      ...
      longDesc:
        "Proyek ini berfokus pada perancangan aplikasi visualisasi data Manajemen Pemasaran dan Penerimaan Mahasiswa berbasis website untuk Divisi Promosi Universitas Kristen Satya Wacana (UKSW). Antarmuka aplikasi dikembangkan menggunakan Figma dengan memanfaatkan kemampuan kolaborasi dan prototyping-nya untuk menciptakan pengalaman pengguna yang intuitif serta berpusat pada kebutuhan pengguna.",
