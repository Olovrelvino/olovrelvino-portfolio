  ...
  <div className="about-center-container">
    ...
    <div className="about-glass-card">
      <p className="about-lead-text">
        I am a developer and designer driven by a passion for crafting flawless user interfaces 
        and extracting meaningful insights from complex data structures.
      </p>
      
      <p className="about-body-text">
        With a robust foundation spanning front-end architectures and contemporary design systems, 
        I bridge the gap between aesthetic design and functional engineering. My ultimate goal 
        is to build fast, scalable, and beautifully interactive digital experiences.
      </p>
