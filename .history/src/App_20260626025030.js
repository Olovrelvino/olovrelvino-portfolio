      ...
      <footer className="footer-section">
        ...
        <div className="footer-container">
          ...
          <div className="footer-left">
            ...
            <p className="footer-copyright">&copy; {new Date().getFullYear()} Alexandre.</p>
          </div>
          ...
          <div className="footer-right">
            ...
            <div className="footer-mini-socials">
              <a href="https://github.com/usernamekamu" target="_blank" rel="noreferrer" title="GitHub">
                <i className="bx bxl-github"></i>
              </a>
              <a href="https://linkedin.com/in/usernamekamu" target="_blank" rel="noreferrer" title="LinkedIn">
                <i className="bx bxl-linkedin"></i>
              </a>
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=emailkamu@gmail.com" target="_blank" rel="noreferrer" title="Email">
                <i className="bx bx-envelope"></i>
              </a>
            </div>
          </div>
