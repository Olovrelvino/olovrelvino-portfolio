...
<div className="home-center-content">
        ...
        <div className="promo-badge">
          ...
          <span className="badge-text">Just shipped v2.0</span>
        </div>

        <h1 className="hero-title">
          Oliver Elvino Putra Pratama
        </h1>
        ...
        <div className="hero-socials">
          <a href="https://www.linkedin.com/in/olovrelvino" target="_blank" rel="noreferrer">
            <i className="bx bxl-linkedin"></i>
          </a>
          <a href="https://www.instagram.com/olovrelvino/" target="_blank" rel="noreferrer">
            <i className="bx bxl-instagram"></i>
          </a>
          <a href="https://github.com/Olovrelvino" target="_blank" rel="noreferrer">
