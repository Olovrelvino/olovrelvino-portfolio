...
function App() {
      ...
      experiences: [
        {
          ...
          period:  language === "ID" ? "Agu 15 – Des 15, 2025"                      : "Aug 15 – Dec 15, 2025",
          items:   language === "ID" ? [
            "Menganalisis kebutuhan dan perilaku pengguna",
            "Membuat persona pengguna dan peta perjalanan pengguna",
            "Membuat wireframe dan prototipe interaktif",
            "Menerapkan design system (tombol, ikon, font, warna) untuk tampilan yang konsisten",
            "Melakukan pengujian kegunaan dan mengumpulkan umpan balik pengguna",
          ] : [
            "Analyze user needs and user behavior",
            "Create user personas and user journey maps",
            "Create wireframing and build interactive prototypes",
            "Implemented design system (buttons, icons, fonts, colors) for a consistent look",
            "Test usability and gather user feedback",
          ],
        },
        {
          role:    language === "ID" ? "Divisi Akomodasi & Transportasi"             : "Accommodation & Transportation Division",
          company: language === "ID" ? "Panitia LKMMTD (Basic Student Leadership)"  : "Basic Student Leadership Training Committee",
          period:  language === "ID" ? "6–7 Juli & 8–10 Juli 2024"                  : "July 6–7 & July 8–10, 2024",
          items:   language === "ID" ? [
  ...
  const popupDetails = {
    project1: {
      ...
      screenshots: ["asset/homeTimMarketing.jpg","asset/taskMarketing.jpg","asset/listLaporan.jpg","asset/managerDashboard.jpg","asset/scheduleAdmin.jpg","asset/amaAdmin.jpg"],
    ...
    project2: {
      ...
      screenshots: ["asset/sdgSWeb.png","asset/eventPage.jpg","asset/aboutPage.jpg","asset/newsPage.jpg"],
      features: language === "ID" ? [
    ...
    project4: {
      ...
      tags: ["PHP", "MySQL"],
      screenshots: ["asset/lilLogin.png","asset/lilHome.png","asset/lilBelanja.png","asset/lilOrder.png","asset/lilProduk.png"],
      features: language === "ID" ? [
              ...
              {t.about.experiences.map((exp, idx) => (
                <div className="exp-item" key={idx}>
                  ...
                  <div className="exp-timeline-line">
                    ...
                    {idx < t.about.experiences.length - 1 && <div className="exp-connector"></div>}
                  </div>
                  {/* Konten */}
