...
<LiquidEther
      // 1. Menyelaraskan 3 warna utama dengan font Cyan dan aksen ungu portofolio Anda
      colors={[ '#00ffee', '#009688', '#2b1055' ]} 
      mouseForce={35}
      cursorSize={80}
      isViscous={true}
      viscous={30}
      ...
      isBounce={false}
      autoDemo={true}
      autoSpeed={0.3}         // Diperlambat sedikit agar transisinya lebih elegan dan halus
      autoIntensity={1.5}
      takeoverDuration={0.25}
      autoResumeDelay={2000}
      autoRampDuration={0.6}
      // 2. Sesuaikan fallback color jika canvas dimuat awal
      color0="#00ffee"        // Cerah Cyan sesuai font utama Anda
      color1="#00bcd4"        // Gradasi Cyan gelap
      color2="#1f242d"        // Warna dasar background gelap Anda agar menyatu
    />
  </div>
