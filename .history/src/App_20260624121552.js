...
<section id="skills" className="skills">
  <div className="skills-center-container">
    ...
    <div className="skills-brief-card">
      <p>
        I master a wide range of technologies spanning front-end development, scripting languages, 
        and UI/UX prototyping tools to engineer fast, responsive, and robust digital solutions.
      </p>
    </div>

    {/* Tengah: LOGO TECH STACK INFINITE LOOP TRACK */}
    {/* Menggunakan ikon Boxicons dari template Anda. List di-duplikat (x2) agar putaran loop tidak terputus */}
    <div className="tech-slider-container">
      <div className="tech-slide-track">
        
        {/* Set 1 */}
        <div className="slide-item"><i className="bx bxl-html5"></i><span>HTML5</span></div>
        <div className="slide-item"><i className="bx bxl-css3"></i><span>CSS3</span></div>
        <div className="slide-item"><i className="bx bxl-javascript"></i><span>JavaScript</span></div>
        <div className="slide-item"><i className="bx bxl-php"></i><span>PHP</span></div>
        <div className="slide-item"><i className="bx bxl-python"></i><span>Python</span></div>
        <div className="slide-item"><i className="bx bxl-figma"></i><span>Figma</span></div>
        <div className="slide-item"><i className="bx bxl-visual-studio"></i><span>C Language</span></div>
        <div className="slide-item"><i className="bx bxs-data"></i><span>MySQL</span></div>
    ...
    <div className="skills-progress-centered">
      ...
      <div className="progress-item">
        <div className="progress-info">
          <span>Frontend Development (HTML/CSS/JS)</span>
          <span>95%</span>
        </div>
        <div className="progress-bar">
      ...
      <div className="progress-item">
        <div className="progress-info">
          <span>Backend & Scripting (PHP/Python/C)</span>
          <span>70%</span>
        </div>
        <div className="progress-bar">
