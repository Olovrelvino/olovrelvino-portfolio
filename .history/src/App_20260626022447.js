        ...
        <div className="contact-container">
          ...
          <div className="contact-left-panel">
            ...
            <p className="contact-side-desc">
              Punya ide proyek menarik, tawaran kolaborasi, atau sekadar ingin berdiskusi? 
              Pilih salah satu platform di samping untuk langsung terhubung dengan saya.
            </p>
          </div>
          ...
          <div className="contact-right-panel">
            ...
            >
              ...
              <div className="action-details">
                ...
                <h4>linkedin.com/in/usernamekamu</h4>
              </div>
              <div className="action-arrow">
                <i className="bx bx-right-arrow-alt"></i>
              </div>
