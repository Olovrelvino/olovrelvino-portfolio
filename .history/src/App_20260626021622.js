      ...
      <section id="contact" className="contact">
        <div className="contact-center-container">
          ...
          <div className="contact-brief-card">
            <p>
              Punya ide proyek menarik, tawaran kolaborasi, atau sekadar ingin bertanya? 
              Silakan hubungi saya melalui platform di bawah ini. Saya akan merespons secepat mungkin.
            </p>
          </div>

          {/* Grid Kontak Utama dengan Efek Liquid Glass */}
          <div className="contact-glass-grid">
            ...
            >
              ...
              <div className="contact-arrow-go">
