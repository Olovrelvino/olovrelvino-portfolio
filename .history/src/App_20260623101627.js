...
function App() {
  ...
  const popupDetails = {
    project1: {
      ...
      year: "2025",                            // <--- Tahun bisa diganti sesuai keinginan
      linkIcon: "bx bxl-behance",              // <--- Ikon Boxicons untuk Behance
      linkLabel: "Behance",                    // <--- Tulisan di samping ikon
      linkUrl: "https://www.behance.net/gallery/247350499/Marketing-Management-Application", // <--- Link tujuan saat diklik
