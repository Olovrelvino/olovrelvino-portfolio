...
function App() {
  ...
  const popupDetails = {
    project1: {
      ...
      linkLabel: "Behance",                   
      linkUrl: "https://www.behance.net/gallery/247350499/Marketing-Management-Application", 
      imgSrc: "asset/homeTimMarketing.jpg",
      longDesc:
        "Proyek ini berfokus pada perancangan aplikasi visualisasi data Manajemen Pemasaran dan Penerimaan Mahasiswa 
        berbasis website untuk Divisi Promosi Universitas Kristen Satya Wacana (UKSW). Antarmuka aplikasi dikembangkan menggunakan Figma dengan memanfaatkan kemampuan kolaborasi dan prototyping-nya untuk menciptakan pengalaman pengguna yang intuitif serta berpusat pada kebutuhan pengguna.",
    ...
    project2: {
      ...
      year: "2024",
      linkIcon: "bx bx-code-alt",              // <--- Ikon bawaan berbentuk simbol kode </>
      linkLabel: "Source Code",                // <--- Tulisan label disesuaikan
    ...
    project4: {
      ...
      year: "2025",
      linkIcon: "bx bxl-github",               // <--- Menggunakan ikon logo GitHub langsung
      ...
      screenshots: ["asset/homeTimMarketing.jpg", "asset/sdgSWeb.png"],
      features: [
    ...
    project5: {
      ...
      year: "2025",
      linkIcon: "bx bx-link",                  // <--- Contoh jika ingin diganti link demo website live
      linkLabel: "Live Demo",
    ...
    <>
      ...
      <section id="home" className="home">
        <div className="home-content">
          ...
          <h3>And I'm <span className="highlight">UI/UX Designer & Frontend Enthusiast</span></h3>
          <p>
            I build interactive web experiences and transform data into meaningful insights. 
            Passionate about clean UI, modern design systems, and data-driven solutions.
          </p>
          <div className="home-buttons">
            <a href="#portfolio" className="btn">Visit Works</a>
            <a href="CV - Oliver Elvino Putra Pratama.pdf" className="btn btn-cv" download>
              <i className="text bx bx-download"></i> Download CV
            </a>
          </div>
          <div className="social-media">
            <a href="https://www.linkedin.com/in/olovrelvino" target="_blank" rel="noreferrer"><i className="bx bxl-linkedin"></i></a>
            <a href="https://www.instagram.com/olovrelvino/" target="_blank" rel="noreferrer"><i className="bx bxl-instagram"></i></a>
            <a href="https://github.com/Olovrelvino" target="_blank" rel="noreferrer"><i className="bx bxl-github"></i></a>
          </div>
        </div>
        <div className="home-img">
          <div className="home-card">
            ...
            <div className="tech-stack">
              <span>HTML</span><span>CSS</span><span>PHP</span><span>Python</span><span>C</span><span>Figma</span><span>MySQL</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="about">
        <div className="about-container">
          <div className="about-card">
            ...
            <p>I'm Oliver Elvino Putra Pratama, an IT student passionate about building elegant frontend interfaces and solving real-world problems through data science.</p>
            <div className="about-info">
              <div className="info-box"><h3>3+</h3><span>Years Learning</span></div>
              <div className="info-box"><h3>10+</h3><span>Projects Built</span></div>
              <div className="info-box"><h3>Frontend</h3><span>Main Focus</span></div>
            </div>
            <a href="#contact" className="btn">Let's Talk</a>
          </div>
          <div className="about-visual"><div className="about-glow"></div></div>
        </div>
      </section>
      ...
      <section id="skills" className="skills">
        ...
        <div className="skills-container">
          <div className="skills-card">
            ...
            <p>I focus on building clean, responsive, and interactive user interfaces while also exploring data science and machine learning workflows.</p>
            <div className="tech-stack-large">
              <span>HTML5</span><span>CSS3</span><span>PHP</span><span>Python</span><span>Figma</span><span>User Interface Design</span>
            </div>
          </div>
          <div className="skills-progress">
            <div className="progress-item">
              <div className="progress-info"><span>HTML & CSS</span><span>95%</span></div>
              <div className="progress-bar"><div className="progress-line html"></div></div>
            </div>
            <div className="progress-item">
              <div className="progress-info"><span>Figma</span><span>90%</span></div>
              <div className="progress-bar"><div className="progress-line figma"></div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="portfolio" className="portfolio-section">
        <div className="portfolio-header">
          <h2>Selected <span className="highlight">Projects</span></h2>
          ...
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-scrollable-content">
              <div className="modal-body">
                <img src={activeProject.imgSrc} alt={activeProject.title} className="modal-main-image" />
                ...
                <div className="modal-meta">
                  ...
                  {activeProject.linkUrl && (
                    ...
                    >
                      <i className={activeProject.linkIcon}></i> {activeProject.linkLabel}
                    </a>
                  )}
                </div>
                ...
                <div className="screenshot-horizontal-scroll">
                  {activeProject.screenshots.map((screen, idx) => (
                    <div className="screenshot-scroll-card" key={idx} onClick={() => setPreviewImageIndex(idx)}>
      ...
      {previewImageIndex !== null && activeProject && (
        <div className="image-preview-overlay" onClick={() => setPreviewImageIndex(null)}>
          ...
          <div className="preview-image-box" onClick={(e) => e.stopPropagation()}>
            <img src={activeProject.screenshots[previewImageIndex]} alt="Pratinjau Besar" className="preview-main-img" />
